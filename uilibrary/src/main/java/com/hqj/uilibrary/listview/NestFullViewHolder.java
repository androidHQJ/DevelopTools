package com.hqj.uilibrary.listview;
...
//    public NestFullViewHolder setMText(@IdRes int viewId, String content) {
//        MTextView view = getView(viewId);
...
//    }
     ...
     * @return
     */
    public NestFullViewHolder setText(int viewId, CharSequence text) {
    ...
    public NestFullViewHolder setTextColorStateListRes(int viewId, int textColorRes) {
        TextView view = getView(viewId);
