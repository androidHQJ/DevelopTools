...
import com.wxq.commonlibrary.util.CommonTools;
...
public abstract class BaseItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount1 - 1; i++) {
            if (positions != null && CommonTools.containInt(positions, i)) {
                continue;
            }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (positions != null && CommonTools.containInt(positions, itemPosition)) {
            return;
        }
        //
        boolean[] sideOffsetBooleans = getItemSidesIsHaveOffsets(itemPosition);
