package com.hqj.uilibrary.recycleview.itemdecoration;
...
import com.juzi.common.utils.DisplayUtils;
import com.juzi.common.widget.recycler.itemdecoration.listener.OnSuspensionListener;
...
public class SuspensionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int index = 0; index < childCount; index++) {
            ...
            c.drawText(currentCityName, left + DisplayUtils.dip2px(12), baseLine + DisplayUtils.dip2px(5), paint);
        }
    }
